        ...
        <div class="nouveau-ticket">
            <div class="nouveau-ticket-textes">
                ...
                <?php else : ?>
                    ...
                    <p>Enregistrez les échanges et les actions réalisé dans le cadre du suivi client.</p>
                <?php endif; ?>
            </div>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="ligne-double">
                            <div class="groupe-input">
                                ...
                                <select id="logiciel" name="logiciel" required>
                                    ...
                                    <option value="IWAN_CAISSE" <?= ($_POST['logiciel'] ?? '') === 'IWAN_CASSE' ? 'selected' : '' ?>>IWAN CAISSE</option>
                                    <option value="AUTRE" <?= ($_POST['logiciel'] ?? '') === 'AUTRE' ? 'selected' : '' ?>>AUTRE</option>
                                </select>
                            </div>
                            <div class="groupe-input">
                                <label for="logiciel">Type de suivi</label>
                                <select id="logiciel" name="logiciel" required>
                        ...
                        <div class="ligne-double">
                            <div class="groupe-input">
                                ...
                                <input type="text" id="suivi_nom" name="nom_contact" placeholder="Nom de la personne au téléphone" required />
                            </div>
                            <div class="groupe-input">
                                <label for="suivi_prenom">Prénom de l'interlocuteur</label>
                                <input type="text" id="suivi_prenom" name="prenom_contact" placeholder="Prénom de la personne au téléphone" required />
                            </div>
                        </div>
